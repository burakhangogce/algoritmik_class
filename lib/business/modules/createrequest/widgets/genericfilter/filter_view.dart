...
import '../../../../commons/widgets/dividers/ghost_divider.dart';
                  ...
                  children: [
                    editingControllerSearch.text.isNotEmpty
                        ? IconButton(
                            ...
                            icon:
                                Image.asset("assets/images/sifre_mail_sil.png"),
                          )
                        : Container(),
                    Image.asset("assets/images/Line_178.png"),
                    IconButton(
                      onPressed: () {},
                      icon: Image.asset("assets/images/Arama.png"),
                    ),
                  ],
                ),
              ),
